...
activities = [
    ...
    {"img": "Christmas Party", "caption": "A joyful celebration with the holiday spirit held during the holiday season."},
    ...
    {"img": "Intrams", "caption": "OBMC High School Intramurals serves as a practical application of the skills learned in P.E. Class. Develop sportsmanship and teamwork among students. Boost physical stamina. Strengthens self-discipline and determination."},
